...
if not skip_step:
    ...
    # Configure signals
    signal_df = data_pkl.signal_data[parent_signal] if parent_signal in data_pkl.signal_data else data_pkl.signal_data[parent_signal]
    signal = data_pkl.signal_data[parent_signal][channel] if parent_signal in data_pkl.signal_data else data_pkl.signal_data[parent_signal][channel]
    datetime_signal = data_pkl.signal_data[parent_signal]['datetime'] if parent_signal in data_pkl.signal_data else data_pkl.signal_data[parent_signal]['datetime']
    ...
    # Assume the corrected accelerometer data is stored in data_pkl.signal_data['corrected_acc']
    corrected_acc = data_pkl.signal_data['corrected_acc']
    acc_sampling_rate = calculate_sampling_frequency(data_pkl.signal_data['corrected_acc']['datetime'])
    acc_sampling_rate
